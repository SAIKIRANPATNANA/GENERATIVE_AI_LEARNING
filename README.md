...
- **RAG learning** through tutorials, prototypes, and document-question-answering workflows
- **LLM application building** with practical app-style experiments
...
Work around retrieval pipelines, vector search, PDF understanding, and context-grounded question answering.
...
### Practice Notebooks and Concept Exploration
Jupyter notebooks and experimental material used to understand concepts, test APIs, and learn by implementation.
...
This repo reflects the way I learn best: by building, experimenting, comparing approaches, and gradually turning concepts into practical systems.
...
- This is a learning-first repository, so some folders are exploratory rather than production-ready.
- Larger artifacts, generated files, and local environment clutter should be kept out before public pushes.
- Over time, stronger implementations from this repo may evolve into more polished standalone projects.
...
Generative AI is currently one of the most exciting parts of my learning journey, and this repository represents that evolution in progress.
